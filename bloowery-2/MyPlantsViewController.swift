...
//        let card = myPlantsCV.dequeueReusableCell(withReuseIdentifier: "card", for: indexPath) as! PlantCollectionViewCell
//
//        card.backgroundColor = UIColor(red:0.96, green:0.97, blue:1.00, alpha:1.00)
//
//        card.plantName.text = String("Cтепуша")
//
//        return card
//    }
